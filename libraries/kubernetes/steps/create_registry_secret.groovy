  ...
  inside_sdp_image "helm", {
          ...
          try {
              withCredentials([usernamePassword(credentialsId: docker_registry_cred, usernameVariable: 'DOCKER_USERNAME', passwordVariable: "DOCKER_PASSWORD")]) {
                  ...
                  sh "kubectl create secret docker-registry $secret_name $release_namespace_string --docker-server=$docker_registry_addr --docker-username=$DOCKER_USERNAME --docker-password=$DOCKER_PASSWORD"
              }
          } catch (e) {
